        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-orange-500 font-rajdhani">
                  CS2 BANLIST
                </h1>
                  ...
                  {banData
                    ...
                    .map((ban) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge
                            variant={getReasonBadge(ban.reason)}
                            className="text-xs"
                          >
                            {ban.reason}
                          </Badge>
